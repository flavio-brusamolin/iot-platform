...
import { makeLoadCollectionByIdController } from '../factories/controllers/collection/load-collections/load-collection-by-id-controller-factory'
...
export default (router: Router): void => {
  ...
  router.get('/collections/:collectionId', adaptMiddleware(makeAuthMiddleware()), adaptRoute(makeLoadCollectionByIdController()))
}
